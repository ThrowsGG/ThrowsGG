...
//          $('input[name=petPicture]').attr('value', edit);
      ...
      <div class="container">
         <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5 fadeInUp ftco-animated">
               ...
               <h1 class="mb-0 bread">글작성</h1>
            </div>
         </div>
      </div>
   </section>
   <div class="container">
      <form name="newWrite" id="newWrite" action="./BoardFindPet.do" class="form-horizontal" method="post" onsubmit="return checkForm()">
            ...
            <div class="card-body">
               ...
               <div class="row">
                  <div class="col-lg-5 col-md-5 col-sm-6">
                     ...
                     <div id="editor" class="white-box text-center" contenteditable="true"><img id='output' class="rollover" src="https://www.generationsforpeace.org/wp-content/uploads/2018/03/empty.jpg"></div>
                  </div>
                  <div class="col-lg-7 col-md-7 col-sm-6">
                     ...
                     <div class="col-sm-12">
                        ...
                        <div id="content" class="" contenteditable="true"></div>
                     </div>
                  </div>
                     ...
                     <div class="table-responsive">
                        <table class="table table-striped table-product">
                           <tbody>
                              <tr>
                                 <td><b>작성자 명</b></td>
                                 <td><input name="name" type="text" class="form-control1" value="<%=name%>" readonly></td>
                              </tr>
                              <tr>
                                 <td><b>연락처</b></td>
                                 <td><input id="phone" name="phone" type="text" class="form-control1" placeholder="-는 자동" maxlength=13></td>
                              </tr>
                              <tr>
                                 <td width="390"><b>동물 이름</b></td>
                                 <td><input name="petName" type="text" class="form-control1" placeholder="petName"></td>
                              </tr>
                              <tr>
                                 <td><b>품종</b></td>
                                 <td><input name="breed" type="text" class="form-control1" placeholder="breed"></td>
                              </tr>
                              <tr>
                                 <td><b>분실날짜</b></td>
<!--                                  <td><input name="lostDate" type="text" class="form-control1" placeholder="lostDate"></td> -->
                                    <td>
                                    <div class="input-wrap">
                                       <input type="text" class="form-control1 appointment_date" placeholder="lostDate" name="lostDate"><span class="fa fa-calendar"></span>
                                    </div>
                                    </td>
                              </tr>
                              <tr>
                                 <td><b>성별</b></td>
<!--                                  <td><input name="gender" type="text" class="form-control1" placeholder="gender"></td> -->
                                 <td>
                              ...
                              <tr>
                                 <td><b>나이</b></td>
                                 <td><input name="age" type="text" class="form-control1" placeholder="age"></td>
                              </tr>
                              <tr>
                                 <td><b>특징</b></td>
                                 <!--<td><input name="figure" type="text" class="form-control1" style="width:500px" placeholder="특징"></td> -->
                                 <td><textarea name="figure" cols="50" rows="3" class="form-control1" placeholder="반려동물의 특징을 설명해주세요."></textarea></td>
                              </tr>
                                <tr>
                                 <td><b>분실장소</b></td>
                                 <td>                                                                 </td>
                        ...
                        <div id="map" style="width: 100%; height: 400px;">
                             ...
                             <input type="hidden" value="" id="insertAddress" name="lostPlace">
				            <input id="NAVERaddress" type="text" placeholder="검색할 주소" value="선문대학교">
...
<script>
   ...
   var map = new naver.maps.Map("map", {
	    center: new naver.maps.LatLng(127.072792, 36.7985089),
	    zoom: 15,
	    mapTypeControl: true
	});
	...
	function initGeocoder() {
	    ...
	    searchAddressToCoordinate('충청남도 아산시 탕정면 선문로221번길 70 선문대학교');
	}
