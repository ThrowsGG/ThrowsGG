...
public class Sens_sms_v2 {
	...
	public void sendSMS(String comments, String phonNum) {
		String hostNameUrl = "https://sens.apigw.ntruss.com"; // 호스트 URL
		String requestUrl = "/sms/v2/services/"; // 요청 URL
		String requestUrlType = "/messages"; // 요청 URL
		String accessKey = "0nPCfPiQ1ovQ5SfCXD47"; // 네이버 클라우드 플랫폼 회원에게 발급되는 개인 인증키 // Access Key :
													// https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key
													// ID
		String secretKey = "JF2ysCQwAXZtMRrIZLxkoVpelNzbu1HAuJ8B3mtW"; // 2차 인증을 위해 서비스마다 할당되는 service secret key //
																		// Service Key :
																		// https://www.ncloud.com/mypage/manage/info >
																		// 인증키 관리 > Access Key ID
		String serviceId = "ncp:sms:kr:290336953075:throwsgg"; // 프로젝트에 할당된 SMS 서비스 ID // service ID :
		...
		toJson.put("to", phonNum); // Mandatory(필수), messages.to 수신번호, -를 제외한 숫자만 입력 가능
		toArr.put(toJson);
		...
		bodyJson.put("from", "01066549676"); // Mandatory, 발신번호, 사전 등록된 발신번호만 사용 가능
		// bodyJson.put("subject",""); // Optional, 기본 메시지 제목, LMS, MMS에서만 사용 가능
		bodyJson.put("content", comments); // Mandatory(필수), 기본 메시지 내용, SMS: 최대 80byte, LMS, MMS: 최대
											// 2000byte
