...
public class ProductSelectAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println("ProductSelectAction start");
		...
		ArrayList<ProductVO> productList = instance.selectProduct(pageNum, limit);
		// jacky 추가
		...
		// 추가 끝
		int total_record = instance.dataTotalCount();
		int total_page;
...
//		System.out.println("pageNum : "+productList);
		...
		System.out.println("ProductSelectAction end");
		return forward;
	}
