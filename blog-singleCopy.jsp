...
<%
AbandonList list = new AbandonList();
...
<!-- 											<label for="name">NickName *</label> <input type="text" class="form-control" id="name" value="" readonly="readonly"> -->
<!-- 										</div> -->
											...
											<div class="row d-md-flex justify-content-end">
												<div class="col-md-12 col-lg-6 half p-3 py-5 pl-lg-5 ftco-animate fadeInUp ftco-animated">
													...
													<form action="reservation.bgs" class="appointment" method="post">
														<input type="hidden" value="${sessionScope.id}" name="userid"> <input type="hidden" value="<%=desertionNo%>" name="resdesertionNo">
														<div class="row">
															<div class="col-md-12">
																<div class="form-group">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<div class="input-wrap">
																		...
																		<input type="text" class="form-control appointment_date" placeholder="Date" name="calender">
																	</div>
																</div>
															</div>
															<div class="col-md-6">
					...
					<div class="sidebar-box ftco-animate">
						...
						<c:forEach var="Result" items="<%=abandonList.getList()%>">
							<div class="block-21 mb-4 d-flex">
								<a href="blog-single.bgs?DesertionNo=${Result.getDesertionNo()}" class="blog-img mr-4" style="background-image: url('${Result.getFilename()}');"></a>
								<div class="text">
